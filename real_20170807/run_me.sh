...
do
    ...
    bsub -R "rusage[mem=10000]" -n 1 -e log-${prefix}.err -o log-${prefix}.err bash ${dupscript} ${prefix} ${i} ${other}
done
...
do
    ...
    bsub -R "rusage[mem=10000]" -n 1 -e log-${prefix}.err -o log-${prefix}.err bash ${countscript} ${i} ../scripts/combined.gtf processed/
done
...
do
    prefix=$(basename $i | sed "s/.bam$//")
    bsub -R "rusage[mem=10000]" -n 1 -e log-${prefix}.err -o log-${prefix}.err bash ${buildscript} bam/${prefix}.bam processed/${prefix}.h5
done
